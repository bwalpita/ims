...
class Crud_model extends CI_Model
{
    ...
    public function get_all_courses_by_active()
    {
        $this->db->where('status', 'active');
    ...
    public function course_purchase($user_id, $method, $amount_paid, $param1 = "", $param2 = "")
    {
     ...
     public function course_manual_payment($user_id, $method, $course_id, $course_payment, $param1 = "", $param2 = "")
    {
