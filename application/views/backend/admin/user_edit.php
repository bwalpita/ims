                        ...
                        <div class="tab-content b-0 mb-0">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control select2" id="course_id" name="course_id" data-init-plugin="select2" required>
                                                    ...
                                                    <?php foreach ($courses as $course): ?>
                                                        <option value="<?php echo $course['id']; ?>" <?php if($course['id'] == $user_data['course_id']) echo 'selected'; ?>><?php echo $course['title']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane" id="payment_info">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="payment_type_flag"> <?php echo get_phrase('payment_type'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                 <select class="form-control select2" id="payment_type_flag" name="payment_type_flag" data-init-plugin="select2" required>
                                                    <option value=""><?php echo get_phrase('Select_Type'); ?></option>
                                                    <option value="1" <?php if($user_data['payment_type_flag'] == 1) echo 'selected'; ?>>Full</option>
                                                    <option value="0" <?php if($user_data['payment_type_flag'] == 0) echo 'selected'; ?>>Partial</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
